...
<header id="home" class="padded-section canvas-section">
  <div class="container">
    <div class="row">
      <div class="col-md-4">
        <h2>RED ANT is a</h2>
        <h1 class="text-x-large pb-3">technical agency</h1>
        <hr align="left">
        <p>We create exceptional digital products</p>
      </div>
    </div>
  </div>

  <div id="parallax-header" class="parallax-container text-center">
...
<section id="build" class="bg-dark padded-section">
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <h3>We build stuff. Digital platforms that engage users, and allow people to learn and do things in interesting ways.</h3>
        <p>We think there are massive opportunities as media &amp; TV fragments. Opportunities to stop paying for eyeballs
          and traffic. Opportunities to build direct and authentic connections with people.</p>
        <p>But to get there you need to provide a fantastic experience, and provide true utility. You need top notch product,
          developers and designers to get you there. That’s where we come in.</p>
      </div>
      <div class="col-md-6">
        <ul>
          <li>We have lots of experience around ecommerce and deep user engagement</li>
          <li>We make things from scratch, as well as "glue together" other platforms or tools such as CRM</li>
          <li>We provide a unique Platform as a Service model</li>
        </ul>
      </div>
    </div>
  </div>
...
<section id="platform" class="bg-gray-light padded-section">
  <div class="container">
    <div class="row">
      <div class="col-md-5 text-center">
        <svg data-aos-anchor="#platform" data-aos="platform-svg" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 256 268" enable-background="new 0 0 256 268" xml:space="preserve" width="256">
      ...
      <div class="col-md-7">
        <h3>The Platform as a Service</h3>
        <p>Like the song goes (kind of) - behind every great team there is a great platform. Wow, that doesn’t even rhyme...</p>
        <p>We’ve been in business for over 20y. And we know that no matter how awesome are developers are, they’ll struggle
          to be consistently fantastic unless everything *just works*. Write some code and it is tested instantly. Set
          up servers for a new project in seconds rather than days.</p>
      </div>
    </div>
  </div>
</section>

<section id="process" data-aos-anchor-placement="center-center">
  <div class="container">
    <div class="row">
      <div class="col-md-6 col-lg-4 tile">
        <span class="tile-count">1</span>
        <div class="step-img step-1"></div>
        <h4>Planning Suite</h4>
        <p>Get the plan wrong and the rest of the project will suffer. These tools help us do group estimates, analyse risk,
          and allocate resources. Oh and some very cool graphs. A day is not complete without graphs. Make sure you check
          the graphs.</p>
      </div>
      <div class="col-md-6 col-lg-4 tile bg-gray-light">
        <span class="tile-count">2</span>
        <div class="step-img step-2"></div>
        <h4>Architecture Toolkit</h4>
        <p>We’ve made some fairly big things. Complex, tricky projects. And we need to update and keep them running. Rather
          than “oh, you need to check with Milo on that”, our playbooks provide designers and coders with a framework for
          optimising the build from the ground up.</p>
      </div>
      <div class="col-md-6 col-lg-4 tile">
        <span class="tile-count">3</span>
        <div class="step-img step-3"></div>
        <h4>Automated Testing</h4>
        <p>Ever been in a situation where you get one thing fixed, and two things break? Turns out you were probably missing
          Tests. For each piece of code a developer writes, they also create a script that automatically tests that code,
          so any errors are identified long before a user sees it.</p>
      </div>
      <div class="col-md-6 col-lg-4 tile bg-gray-light">
        <span class="tile-count">4</span>
        <div class="step-img step-4"></div>
        <h4>Continuous Integration</h4>
        <p>Each line of code is sucked up and integrated into the platform which runs through even more tests, checking for
          unnecessary complexity, bad code or repetition.</p>
      </div>
      <div class="col-md-6 col-lg-4 tile">
        <span class="tile-count">5</span>
        <div class="step-img step-5"></div>
        <h4>Live Monitoring &amp; Reporting</h4>
        <p>Get the plan wrong and the rest of the project will suffer. These tools help us do group estimates, analyse risk,
          and allocate resources. Oh and some very cool graphs. A day is not complete without graphs. Make sure you check
          the graphs.</p>
      </div>
      <div class="col-md-6 col-lg-4 tile bg-gray-light">
        <span class="tile-count">6</span>
        <div class="step-img step-6"></div>
        <h4>DevOps</h4>
        <p>The platform constantly measures live performance based on a set of metrics - anything from user load time to database
          performance.
        </p>
      </div>
    </div>
...
<section id="portfolio">
  <div class="carousel">
    ...
    <div class="slide mb12wbt">
      <div class="container">
        <div class="row">
          <div class="col-md-5 py-5">
            <div class="content">
              <svg version="1.1" id="mb12wbt_logo" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="120px" height="46.63px" viewBox="0 0 120 46.63" enable-background="new 0 0 120 46.63" xml:space="preserve" class="logo">
              ...
              <div class="sep"></div>
              <h2>A health and fitness product</h2>
              <p>A digital product in the health and fitness area which has been incredibly popular, changing thousands of
                lives. Every second person we meet seems to either be doing it or know someone that is a raving fan.</p>
              <p>Packed full of amazing features, dynamic user segmentation… oh shut up already. This space can’t do 12WBT
                justice – it is truly an amazing digital product.</p>
            </div>
          </div>
        </div>
      </div>
      <div class="slide-img-wrapper">
        <svg class="preview" data-aos-anchor="#portfolio" data-aos="slide-left" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="678px" height="644px" viewBox="0 0 678 644" enable-background="new 0 0 678 644" xml:space="preserve">
          <defs>
            <clipPath id="clip">
              <rect fill="none" width="678" height="644"></rect>
            </clipPath>
          </defs>
          <g clip-path="url(#clip)">
            <g class="big" transform="translate(-45 75)">
              <g transform="translate(0 40)" opacity="0.10" class="shadow4">
                <rect fill="#000000" width="455" height="719" transform="rotate(-30 455 0) skewX(30)"></rect>
              </g>
              <g transform="translate(0 30)" opacity="0.15" class="shadow3">
                <rect fill="#000000" width="455" height="719" transform="rotate(-30 455 0) skewX(30)"></rect>
              </g>
              <g transform="translate(0 20)" opacity="0.20" class="shadow2">
                <rect fill="#000000" width="455" height="719" transform="rotate(-30 455 0) skewX(30)"></rect>
              </g>
              <g transform="translate(0 10)" opacity="0.25" class="shadow1">
                <rect fill="#000000" width="455" height="719" transform="rotate(-30 455 0) skewX(30)"></rect>
              </g>
              <g transform="rotate(-30 455 0) skewX(30)" class="art">
                <image overflow="visible" width="455" height="719" xlink:href="images/12wbt/12wbt-455x719.png"></image>
              </g>
            </g>
            <g class="small" transform="translate(-10 437)">
              <g transform="translate(0 40)" opacity="0.10" class="shadow4">
                <rect fill="#000000" width="185" height="329" transform="rotate(-30 185 0) skewX(30)"></rect>
              </g>
              <g transform="translate(0 30)" opacity="0.15" class="shadow3">
                <rect fill="#000000" width="185" height="329" transform="rotate(-30 185 0) skewX(30)"></rect>
              </g>
              ...
              <g transform="rotate(-30 185 0) skewX(30)" class="art">
                <image overflow="visible" width="185" height="329" xlink:href="images/12wbt/12wbt-185x329.png"></image>
              </g>
            </g>
          </g>
        </svg>
    ...
    <div class="slide huggies">
      <div class="container">
        <div class="row">
          <div class="col-md-5 py-5">
            <div class="content">
              <svg version="1.1" id="huggies_logo" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="120px" height="73.23px" viewBox="0 0 120 73.23" enable-background="new 0 0 120 73.23" xml:space="preserve" class="logo">
              ...
              <div class="sep"></div>
              <h2>A place for parents to learn & share</h2>
              <p>Yes, Huggies like in the nappies you put on babies. Try searching for anything baby or child related, and
                you’ll probably end up on a Huggies page. So much more than a brand site for Nappies – everything you need
                to know if you’re the proud owner of a 0-5 year old, or if you’re pregnant. Close to half the Mums in Australia
                are members, so we must be doing something right.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <svg class="preview" data-aos-anchor="#portfolio" data-aos="slide-left" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="678px" height="644px" viewBox="0 0 678 644" enable-background="new 0 0 678 644" xml:space="preserve">
          ...
          <g clip-path="url(#clip)">
            <g class="big" transform="translate(-45 75)">
              ...
              <g transform="rotate(-30 455 0) skewX(30)" class="art">
                <image overflow="visible" width="455" height="719" xlink:href="images/huggies/huggies-455x719.png"></image>
              </g>
            </g>
            <g class="small" transform="translate(-10 437)">
              <g transform="translate(0 40)" opacity="0.10" class="shadow4">
              ...
              <g transform="rotate(-30 185 0) skewX(30)" class="art">
                <image overflow="visible" width="185" height="370" xlink:href="images/huggies/huggies-185x370.png"></image>
              </g>
            </g>
          </g>
        </svg>
    ...
    <div class="slide plando">
      <div class="container">
        <div class="row">
          <div class="col-md-5 py-5">
            <div class="content">
              <svg version="1.1" id="plando_logo" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="120px" height="64.87px" viewBox="0 0 120 64.87" enable-background="new 0 0 120 64.87" xml:space="preserve" class="logo">
              ...
              <div class="sep"></div>
              <h2>Digital career management</h2>
              <p>LinkedIn is for what you’ve done. PlanDo is for managing what you want to be. We’ve been helping Plando build
                a career management platform that will shakeup the world of employment and careers by giving individuals
                the tools to manage their own careers.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <svg class="preview" data-aos-anchor="#portfolio" data-aos="slide-left" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="678px" height="644px" viewBox="0 0 678 644" enable-background="new 0 0 678 644" xml:space="preserve">
          ...
          <g clip-path="url(#clip)">
            <g class="big" transform="translate(-45 75)">
              ...
              <g transform="rotate(-30 455 0) skewX(30)" class="art">
                <image overflow="visible" width="455" height="719" xlink:href="images/plando/plando-455x719.png"></image>
              </g>
            </g>
            <g class="small" transform="translate(-10 437)">
              <g transform="translate(0 40)" opacity="0.10" class="shadow4">
              ...
              <g transform="rotate(-30 185 0) skewX(30)" class="art">
                <image overflow="visible" width="185" height="328" xlink:href="images/plando/plando-185x328.png"></image>
              </g>
            </g>
          </g>
        </svg>
