...
<header class="project-header">
  <div class="project-header-content">
    <div class="bg-angled bg-huggies"></div>
    {% include svg/project-header-reverse.html desktop_image="/assets/huggies-455x719.png" mobile_image="/assets/huggies-185x370.png" %}
  </div>
</header>
