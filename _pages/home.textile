...
<header class="padded-section canvas-section">
  <div class="container">
    <div class="row">
      <div class="col-md-4">
        <h2><img class="logo" src="{{ site.data.webpack['/assets/logo.svg'] }}" /> is a</h2>
  ...
  <div class="parallax-container text-center">
    <div class="parallax-layer" data-depth="0.4">
      <div class="parallax-content">
        <img src="{{ site.data.webpack['/assets/grid.png'] }}" />
      </div>
    </div>
...
<section class="navbar-aos bg-dark padded-section">
  <div class="container">
    <div class="row">
      <div class="col-md-6">
      ...
      <div class="col-md-6">
        <ul class="about-us-list">
          <li class="red">We have lots of experience around ecommerce and deep user engagement</li>
          <li class="green">We make things from scratch, as well as "glue together" other platforms or tools such as CRM</li>
          <li class="blue">We provide a unique Platform as a Service model</li>
        </ul>
      </div>
    </div>
  </div>
...
<section class="section-border" data-aos-anchor-placement="center-center">
  <div class="container">
    <div class="row">
  ...
  <div class="carousel">
    <div class="slide mb12wbt">
      ...
      <div class="svg-wrapper">
        {% include svg/project-header.html desktop_image="/assets/12wbt-455x719.png" mobile_image="/assets/12wbt-185x329.png" %}
      </div>
    </div>
    ...
    <div class="slide huggies">
      ...
      <div class="svg-wrapper">
        {% include svg/project-header.html desktop_image="/assets/huggies-455x719.png" mobile_image="/assets/huggies-185x370.png" %}
      </div>
    </div>
    ...
    <div class="slide plando">
      ...
      <div class="svg-wrapper">
        {% include svg/project-header.html desktop_image="/assets/plando-455x719.png" mobile_image="/assets/plando-185x328.png" %}
      </div>
    </div>
  </div>
</section>
