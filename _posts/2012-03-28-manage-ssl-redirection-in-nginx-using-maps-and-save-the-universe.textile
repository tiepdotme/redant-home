...
<pre class="code">map $uri $example_org_preferred_proto {
	default "http";
...
h2. But I'm behind a load balancer which handles the SSL, so this won’t work for me!
