...
h2. Jenkins (Continuous Integration)
...
As features are completed, they are merged back into the Develop branch, which "Jenkins then automatically deploys":/blog/a-look-inside-our-jenkins-pipeline-how-we-make-reliable-stuff/ to a development server for review. Once these are all approved, we make a release and these changes get added to the master version. These then get pushed up to the live production site.
