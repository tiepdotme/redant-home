...
The deploy blocker comes up on our "interactive wallboard":http://redant.com.au/blog/the-story-behind-our-wallboard-whos-working-on-what-and-can-i-deploy-yet/ so everyone is aware. Our Capistrano deployment process also won’t allow anything to be deployed to the Production servers until this issue is closed.
