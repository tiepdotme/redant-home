...
You're probably wondering if Ruby is right for your project. While there are many good reasons to choose Ruby it will ultimately depend on your specific goals and resources. If you're just getting started why not book in for a [free initial consultation](https://redant.com.au/free-initial-consult-code-review/ "free initial consultation") to talk about your plans. If you already have an existing website, book in for a [code review](https://redant.com.au/ruby-on-rails-code-review/ "Code Review ") to explore the strengths and options for your existing development. Helping start ups and existing companies understand their development options is what we do best. 
