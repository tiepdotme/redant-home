...
h3. How Google email image caching actually works (rather than how email vendors would prefer to believe it works)
...
h2. Results in a nutshell

h4. 1. Images are retrieved for first user and then cached
...
h4. 3. The fetching IP will be Google rather than your user
...
<pre>Mozilla/5.0 (Windows; U; Windows NT 5.1; de; rv:1.9.0.7) Gecko/2009021910 Firefox/3.0.7 (via ggpht.com)</pre>
